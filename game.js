...
function showScene() {
    ...
    // Ép giữ nền cũ nếu cảnh mới không khai báo nền hợp lệ
        ...
        if (isCorrect) {
            ...
            resultDiv.innerHTML = `
                <div style="text-align: center; margin-top: 10px;">
                    ...
                    <img src="assets/vatpham_1.jpg" alt="Lọ pha lê" style="width: 120px; height: auto; border: 2px solid #FFD369; border-radius: 8px; margin: 10px 0; background: rgba(0,0,0,0.5); padding: 5px;"><br>
        ...
        if (isCorrect) {
            ...
            resultDiv.innerHTML = `
                <div style="text-align: center; margin-top: 10px;">
                    ...
                    <img src="assets/vatpham_2.jpg" alt="Dây chuyền" style="width: 120px; height: auto; border: 2px solid #FFD369; border-radius: 8px; margin: 10px 0; background: rgba(0,0,0,0.5); padding: 5px;"><br>
        ...
        if (isCorrect) {
            ...
            resultDiv.innerHTML = `
                <div style="text-align: center; margin-top: 10px;">
                    ...
                    <img src="assets/vatpham_3.jpg" alt="Nhẫn đá" style="width: 120px; height: auto; border: 2px solid #FFD369; border-radius: 8px; margin: 10px 0; background: rgba(0,0,0,0.5); padding: 5px;"><br>
...
function openDuanBoss5Panel() {
    ...
    text.innerHTML = `
        ...
        <div style="margin-bottom: 15px;">
            ...
            <input type="radio" name="boss5" value="lussahna" id="r2"> <label_for="r2" style="font-size:18px; color:white;">Nữ tu Lussahna</label><br><br>
    ...
    document.getElementById("submitBoss5Btn").addEventListener("click", () => {
        ...
        if (selected.value === "lussyh") {
            ...
            resultDiv.innerHTML = `
                <div style="text-align: center; margin-top: 10px;">
                    <p>🎉 CHÍNH XÁC! Bạn nhận được:</p>
                    <img src="assets/vatpham_4.jpg" alt="Lời chúc phúc" style="width: 120px; height: auto; border: 2px solid #FFD369; border-radius: 8px; margin: 10px 0; background: rgba(0,0,0,0.5); padding: 5px;"><br>
        ...
        if (isCorrect) {
            ...
            resultDiv.innerHTML = `
                <div style="text-align: center; margin-top: 10px;">
                    ...
                    <img src="assets/vatpham_5.jpg" alt="Bản kế hoạch" style="width: 120px; height: auto; border: 2px solid #FFD369; border-radius: 8px; margin: 10px 0; background: rgba(0,0,0,0.5); padding: 5px;"><br>
