...
let gameStarted = false; // Biến kiểm tra xem game đã bắt đầu chưa
...
// Cấu hình giao diện ban đầu cho nút Bắt đầu
if (nextBtn) {
...
function showScene() {
    ...
    currentVoice.play().catch(e => console.log("Không tìm thấy file voice hoặc chờ tương tác"));
...
nextBtn.addEventListener("click", () => {
    // Nếu chưa kích hoạt game, bấm phát đầu tiên sẽ bật nhạc và chạy cảnh mở màn
    if (!gameStarted) {
        gameStarted = true;
...
// Thiết lập trạng thái màn hình chờ đen bí ẩn lúc chưa ấn Start
...
function openDuanBossPanel() {
    ...
    text.innerHTML = `
        ...
        <input type="text" id="bossInput" placeholder="Nhập tên kẻ tình nghi (Ví dụ: Sahkar)..." style="width: 70%; padding: 10px; font-size: 18px; border-radius: 4px; border: none; margin-bottom: 15px; color: black;"><br>
...
function openDuanBoss3Panel() {
    ...
    text.innerHTML = `
        ...
        <input type="text" id="boss3Input" placeholder="Nhập đáp án (Ví dụ: Katisah, Japhah, Cả hai...)..." style="width: 70%; padding: 10px; font-size: 18px; border-radius: 4px; border: none; margin-bottom: 15px; color: black;"><br>
...
function openDuanBoss6Panel() {
    ...
    text.innerHTML = `
        ...
        <input type="text" id="boss6Input" placeholder="Nhập suy đoán của bạn..." style="width: 70%; padding: 10px; font-size: 18px; border-radius: 4px; border: none; margin-bottom: 15px; color: black;"><br>
